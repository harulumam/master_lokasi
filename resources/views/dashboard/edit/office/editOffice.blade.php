...
@section('content')
  ...
  @component('components.breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('viewOffice', ['id' => $kode_office]) }}">View Office</a></li>
            ...
            <div class="row mb-3 mt-3">
              <div class="col-12 d-flex align-items-center">
                <label class="form-label me-2" for="">
                  <a href="{{ route('editoffice', ['id' => $kode_office]) }}" style="color: #E63946">Lokasi</a>
                </label>
  ...
  @push('scripts')
    ...
    <script>
      ...
      function goBack(kodeOffice) {
        window.location.href = `/office/${kodeOffice}`;
      }
    </script>
  @endpush
@endsection
