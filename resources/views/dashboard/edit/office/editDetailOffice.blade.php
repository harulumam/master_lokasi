...
@section('title', 'Edit Detail Office')
...
@section('content')
  ...
  @component('components.breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('detailOffice', ['id' => $kode_office]) }}">Detail Office</a></li>
    <li class="breadcrumb-item active">Edit Detail Office</li>
  @endcomponent
    ...
    <div class="row">
        ...
        <div class="card p-3">
          <div class="sidebar">
            <div class="row mb-3 mt-3">
              <div class="col-12 d-flex align-items-center">
                <label class="form-label me-2" for="">
                  <a href="{{ route('editoffice', ['id' => $kode_office]) }}">Lokasi</a>
                </label>
            ...
            <div class="row mb-3">
              <div class="col-12">
                <label class="form-label d-flex justify-content-between align-items-center collapsible-header"
                  ...
                  <span style="color: #E63946">Office</span>
                  <div class="form-check form-switch ms-auto">
                    <input class="form-check-input" type="checkbox" id="toggle"
                      style="background-color: #E63946; border-color: #FFFFFF; cursor: pointer;">
                  </div>
            ...
            <div class="row mb-3 collapsible-content" style="display: none;">
              <div class="col-12">
                <label class="form-label" for=""><a href="{{ route('editDetailOffice', ['id' => $kode_office]) }}"
                    style="color: #E63946">Detail
                    Office</a></label>
                <label class="form-label" for=""><a
                    href="{{ route('editRuanganOffice', ['id' => $kode_office]) }}">Detail Ruangan</a></label>
              </div>
            </div>
            <div class="row mb-3">
              <div class="col-12">
      ...
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <form id="formCreateOffice" method="POST" class="needs-validation" novalidate>
              <div class="mb-3">
                <div class="col-md-12">
                  <label class="form-label" for="id_office">Kode Office</label>
                  <input class="form-control" id="id_office" name="id_office" type="text" value="off-123" readonly />
                </div>
              </div>
              <div class="mb-3">
                <div class="col-md-12">
                  <label class="form-label" for="nama_office">Nama Office</label>
                  <input class="form-control" id="nama_office" name="nama_office" type="text"
                    placeholder="Masukan nama office" required="" />
                  <div class="invalid-feedback">Nama Office wajib diisi.</div>
                </div>
              </div>
              <div class="mb-3">
                <div class="col-md-12">
                  <label class="form-label" for="tipe_office">Tipe Office</label>
                  <select class="form-select" id="tipe_office" name="tipe_office" required="">
              ...
              <div class="row g-2 mb-3">
                <div class="col-md-6">
                  <label class="form-label" for="peruntukan_office">Peruntukan</label>
                  <select class="form-select" id="peruntukan_office" name="peruntukan_office" required="">
                ...
                <div class="col-md-6">
                  <label class="form-label" for="luasan_office">Luasan</label>
                  <input class="form-control" id="luasan_office" name="luasan_office" type="text"
                    placeholder="Masukan luasan office" required="" />
              ...
              <div class="mb-5">
                <label class="form-label" for="koordinat_office">Koordinat Lokasi</label>
                <div class="d-flex">
                  <input class="form-control me-2" id="koordinat_office" name="koordinat_office" type="text"
              ...
              <div class="mb-3">
                <div class="mb-3">
                  <div class="col-md-12">
                    <label class="form-label" for="penanggung_jawab_office">Penanggung Jawab Gudang</label>
                    <select class="form-select" id="penanggung_jawab_office" name="penanggung_jawab_office"
                      required="">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-end mt-3">
              <button class="btn btn-outline-secondary me-2" id="cancelButton" onclick="goBack('{{ $kode_office }}')">Cancel</button>
  ...
  @push('scripts')
    ...
    <script>
      ...
      function goBack(kodeOffice) {
        window.location.href = `/office/detail/${kodeOffice}`;
      }
    </script>
  @endpush
@endsection
