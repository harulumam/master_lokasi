...
@section('title', 'Edit Detail Ruangan Office')
...
@section('content')
  ...
  @component('components.breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('ruanganOffice', ['id' => $kode_office]) }}">Detail Ruangan</a></li>
    <li class="breadcrumb-item active">Edit Detail Ruangan Office</li>
  @endcomponent
            ...
            <div class="row mb-3 collapsible-content" style="display: none;">
              <div class="col-12">
                <label class="form-label" for=""><a
                    href="{{ route('editDetailOffice', ['id' => $kode_office]) }}">Detail Office</a></label>
                <label class="form-label" for=""><a
                    href="{{ route('editRuanganOffice', ['id' => $kode_office]) }}" style="color: #E63946">Detail
                    Ruangan</a></label>
              </div>
            </div>
            <div class="row mb-3">
        ...
        <div class="card">
          <div class="card-body">
            <div id="formContainer">
              <form id="formCreateOffice" method="POST" class="needs-validation dynamic-form" novalidate>
                <div class="mb-3 form-instance" id="form_ruang_0">
                  <div class="row mb-3">
                    ...
                    <div class="content-input">
                      <div class="row mb-3">
                        <div class="col-md-12">
                          <label class="form-label" for="ruangan_office_0">Ruangan</label>
                          <select class="form-select" id="ruangan_office_0" name="ruangan_office[]" required="">
                      ...
                      <div class="row g-2 mb-3">
                        <div class="col-md-5">
                          <label class="form-label" for="luasan_ruang_office_0">Luasan</label>
                          <input class="form-control" id="luasan_ruang_office_0" name="luasan_ruang_office[]"
                            type="text" placeholder="Masukkan luasan" required="" />
                        ...
                        <div class="col-md-6">
                          <label class="form-label" for="tipe_bayar_office_0">Tipe Berbayar</label>
                          <select class="form-select" id="tipe_bayar_office_0" name="tipe_bayar_office[]"
                            required="">
                      ...
                      <div id="alkerContainer" class="alker-container">
                        <div class="alker-instance" id="alker_form_0_0">
                          ...
                          <div class="alker-details">
                            <div class="row g-2 mb-3">
                              <div class="col-md-8">
                                <label class="form-label" for="nama_alker_office_0_0">Nama Alker/Sarker</label>
                                <select class="form-select" id="nama_alker_office_0_0" name="nama_alker_office[]"
                                  required="">
                            ...
                            <div class="row g-2 mb-3">
                              <div class="col-md-9">
                                <label class="form-label" for="tipe_alker_office_0_0">Tipe Alker/Sarker</label>
                                <select class="form-select" id="tipe_alker_office_0_0" name="tipe_alker_office[]"
                                  required="">
                              ...
                              <div class="col-md-3">
                                <label class="form-label" for="qty_offcie_0_0">Qty</label>
                                <input class="form-control" id="qty_offcie_0_0" name="qty_offcie[]" type="text"
          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-end mt-3">
              <button class="btn btn-outline-secondary me-2" id="cancelButton"
                onclick="goBack('{{ $kode_office }}')">Cancel</button>
  ...
  @push('scripts')
    ...
    <script>
      ...
      function goBack(kodeOffice) {
        window.location.href = `/office/ruangan/${kodeOffice}`;
      }
    </script>
  @endpush
@endsection
