...
@section('title', 'Edit Fiber Academy')
...
@section('content')
  ...
  @component('components.breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('viewFa', ['id' => $kode_fa]) }}">View FA</a></li>
    <li class="breadcrumb-item active">Edit Fiber Academy</li>
  @endcomponent
            ...
            <div class="row mb-3 mt-3">
              <div class="col-12 d-flex align-items-center">
                <label class="form-label me-2" for="">
                  <a href="{{ route('editFa', ['id' => $kode_fa]) }}" style="color: #E63946">Lokasi</a>
                </label>
            ...
            <div class="row mb-3 collapsible-content" style="display: none;">
              <div class="col-12">
                <label class="form-label" for=""><a
                    href="{{ route('editDetailFa', ['id' => $kode_fa]) }}">Detail Fiber Academy</a></label>
                <label class="form-label" for=""><a
  ...
  @push('scripts')
    ...
    <script>
      ...
      function goBack(kodeFa) {
        window.location.href = `/fa/${kodeFa}`;
      }
    </script>
  @endpush
@endsection
