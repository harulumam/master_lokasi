...
@section('title', 'Edit Detail Ruangan FA')
...
@section('content')
  ...
  @component('components.breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('ruanganFa', ['id' => $kode_fa]) }}">Detail Ruangan FA</a></li>
    <li class="breadcrumb-item active">Edit Detail Ruangan FA</li>
  @endcomponent
  ...
  <div class="container-fluid dashboard-default-sec">
    <div class="row">
      <div class="col-md-2">
        <div class="card p-3">
          <div class="sidebar">
            ...
            <div class="row mb-3 collapsible-content" style="display: none;">
              <div class="col-12">
                <label class="form-label" for=""><a href="{{ route('editDetailFa', ['id' => $kode_fa]) }}">Detail
                    Fiber Academy</a></label>
                <label class="form-label" for=""><a href="{{ route('editRuanganFa', ['id' => $kode_fa]) }}"
        ...
        <div class="card">
          <a href="{{ route('editRuanganFa', ['id' => $kode_fa]) }}"
                ...
                <div class="mb-3 form-instance" id="form_ruang_0">
                  <div class="row mb-3">
                    ...
                    <div class="content-input">
                      <div class="row mb-3">
                        <div class="col-md-12">
                          <label class="form-label" for="ruangan_fa_0">Ruangan</label>
                          <select class="form-select" id="ruangan_fa_0" name="ruangan_fa[]" required="">
                      ...
                      <div class="row g-2 mb-3">
                        <div class="col-md-5">
                          <label class="form-label" for="luasan_ruang_fa_0">Luasan</label>
                          <input class="form-control" id="luasan_ruang_fa_0" name="luasan_ruang_fa[]" type="text"
                        ...
                        <div class="col-md-6">
                          <label class="form-label" for="tipe_bayar_fa_0">Tipe Berbayar</label>
                          <select class="form-select" id="tipe_bayar_fa_0" name="tipe_bayar_fa[]" required="">
                      ...
                      <div id="alkerContainer" class="alker-container">
                        <div class="alker-instance" id="alker_form_0_0">
                          ...
                          <div class="alker-details">
                            <div class="row g-2 mb-3">
                              <div class="col-md-8">
                                <label class="form-label" for="nama_alker_fa_0_0">Nama Alker/Sarker</label>
                                <select class="form-select" id="nama_alker_fa_0_0" name="nama_alker_fa[]"
                                  required="">
                            ...
                            <div class="row g-2 mb-3">
                              <div class="col-md-9">
                                <label class="form-label" for="tipe_alker_fa_0_0">Tipe Alker/Sarker</label>
                                <select class="form-select" id="tipe_alker_fa_0_0" name="tipe_alker_fa[]"
                                  required="">
          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-end mt-3">
              <button class="btn btn-outline-secondary me-2" id="cancelButton"
                onclick="goBack('{{ $kode_fa }}')">Cancel</button>
  ...
  @push('scripts')
    ...
    <script>
      ...
      function goBack(kode_fa) {
        window.location.href = `/fa/ruangan/${kode_fa}`;
      }
    </script>
  @endpush
@endsection
