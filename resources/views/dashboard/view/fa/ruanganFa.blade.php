...
@section('content')
  ...
  @component('components.breadcrumb')
    ...
    <li class="breadcrumb-item active">Detail Ruangan Fiber Academy</li>
  @endcomponent
  ...
  <div class="container-fluid dashboard-default-sec">
    <div class="row">
      <div class="col-md-2">
          ...
          <div class="sidebar">
            ...
            <div class="row mb-3 collapsible-content" style="display: none;">
              <div class="col-12">
                ...
                <label class="form-label" for=""><a
                    href="{{ route('ruanganFa', ['id' => $kode_fa]) }}" style="color: #E63946">Detail
                    Ruangan</a></label>
              </div>
            </div>
            <div class="row mb-3">
        ...
        <div class="card">
          <a href="{{ route('editRuanganFa', ['id' => $kode_fa]) }}" class="btn btn-danger text-white text-decoration-none">
            Update Data </a>
        </div>
      </div>
      <div class="col-md-6">
