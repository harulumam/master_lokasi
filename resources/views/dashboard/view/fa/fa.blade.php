...
@section('title', 'View Fiber Academy')
...
@section('content')
  ...
  @component('components.breadcrumb')
    ...
    <li class="breadcrumb-item active">View Fiber Academy</li>
  @endcomponent
        ...
        <div class="card p-3">
          <div class="sidebar">
            <div class="row mb-3 mt-3">
              <div class="col-12">
                <label class="form-label" for="">
                  <a href="{{ route('viewFa', ['id' => $kode_fa]) }}" style="color: #E63946">Lokasi</a>
                </label>
              </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3 collapsible-content" style="display: none;">
              <div class="col-12">
                <label class="form-label" for=""><a href="{{ route('detailFa', ['id' => $kode_fa]) }}">Detail
