...
@section('title', 'Detail Ruangan Gudang')
...
@section('content')
  ...
  @component('components.breadcrumb')
    ...
    <li class="breadcrumb-item active">Detail Ruangan Gudang</li>
  @endcomponent
  ...
  <div class="container-fluid dashboard-default-sec">
    <div class="row">
      <div class="col-md-2">
          ...
          <div class="sidebar">
            ...
            <div class="row mb-3 collapsible-content" style="display: none;">
              <div class="col-12">
                ...
                <label class="form-label" for=""><a href="{{ route('ruanganGudang', ['id' => $kode_gudang]) }}"
        ...
        <div class="card">
          <a href="{{ route('editRuanganGudang', ['id' => $kode_gudang]) }}" class="btn btn-danger text-white text-decoration-none">
            Update Data </a>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card">
          <div class="card-body pb-0"> {{-- Ruang Alker --}}
            <label class="form-label d-flex align-items-center header-table" for="" style="cursor: pointer;">
              ...
              <span class="ms-2">
                <h5 class="mb-0 text-dark fw-bold small">Ruang Alker</h5>
              </span>
            </label>
          ...
          <div class="card-body pb-0 pt-0"> {{-- Detail Sarker --}}
            <label class="form-label d-flex align-items-center header-table" for="">
              <span>
                <h5 class="mb-0 text-dark fw-bold small">Detail Sarker</h5>
              </span>
              <span class="qty small">Qty: 2</span>
            </label>
            <label class="form-label d-flex align-items-center header-table" for="" style="cursor: pointer;">
              <i class="fa fa-angle-down toggle-icon fa-lg" style="line-height: 1.5;"></i>
              <span class="ms-2">
                <h5 class="mb-0 text-dark fw-bold small">AC</h5>
              </span>
              <span class="qty small">Qty: 2</span>
            </label>
            <div class="row content-table">
