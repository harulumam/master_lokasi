...
@section('content')
  ...
  @component('components.breadcrumb')
    ...
    <li class="breadcrumb-item active">Detail Office</li>
  @endcomponent
  ...
  <div class="container-fluid dashboard-default-sec">
    <div class="row">
      <div class="col-md-2">
            ...
            <div class="row mb-3 collapsible-content" style="display: none;">
              <div class="col-12">
                <label class="form-label" for=""><a
                    href="{{ route('detailOffice', ['id' => $kode_office]) }}" style="color: #E63946">Detail
                    Office</a></label>
                <label class="form-label" for=""><a
                    href="{{ route('ruanganOffice', ['id' => $kode_office]) }}">Detail Ruangan</a></label>
              </div>
            </div>
            <div class="row mb-3">
              <div class="col-12">
        ...
        <div class="card">
          <a href="{{ route('editDetailOffice', ['id' => $kode_office]) }}"
              ...
              <div class="card">
                <div class="table-responsive">
                  <table class="table table-bordered">
                    <tbody>
                      <tr>
                        <th scope="row" style="width: 150px;">Kode Office</th>
                        <td style="width: 300px;"><?= $kode_office ?></td>
                      </tr>
                      <tr>
                        <th scope="row">Nama Office</th>
                        <td>Office IT</td>
                      </tr>
                      <tr>
