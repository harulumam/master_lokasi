  ...
  // left sidebar and horizotal menu
    if($('#pageWrapper').hasClass('compact-wrapper')){
          ...
          jQuery('.menu-title').append('<div class="according-menu"><i class="fa fa-angle-down"></i></div>');
          if ( $('.menu-title').hasClass('active') )
          {
              ...
              jQuery('.menu-title').find('div').replaceWith('<div class="according-menu"><i class="fa fa-angle-down"></i></div>');
          }
