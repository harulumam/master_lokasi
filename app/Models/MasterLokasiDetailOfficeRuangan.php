...
class MasterLokasiDetailOfficeRuangan extends Model
{
    use HasFactory;
    protected $table = 't_master_lokasi_detail_office_ruangan';
    protected $primaryKey = 'master_lokasi_detail_office_ruangan_id';
